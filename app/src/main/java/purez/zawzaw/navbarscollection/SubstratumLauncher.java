...
import static purez.zawzaw.navbarscollection.ThemerConstants.APK_SIGNATURE_PRODUCTION;
import static purez.zawzaw.navbarscollection.ThemerConstants.BASE_64_LICENSE_KEY;
import static purez.zawzaw.navbarscollection.ThemerConstants.BLACKLISTED_APPLICATIONS;
import static purez.zawzaw.navbarscollection.ThemerConstants.ENABLE_BLACKLISTED_APPLICATIONS;
import static purez.zawzaw.navbarscollection.ThemerConstants.ENFORCE_AMAZON_APP_STORE_INSTALL;
import static purez.zawzaw.navbarscollection.ThemerConstants.ENFORCE_GOOGLE_PLAY_INSTALL;
import static purez.zawzaw.navbarscollection.ThemerConstants.ENFORCE_INTERNET_CHECK;
import static purez.zawzaw.navbarscollection.ThemerConstants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION;
import static purez.zawzaw.navbarscollection.ThemerConstants.MINIMUM_SUBSTRATUM_VERSION;
import static purez.zawzaw.navbarscollection.ThemerConstants.PIRACY_CHECK;
import static purez.zawzaw.navbarscollection.ThemerConstants.SUBSTRATUM_FILTER_CHECK;
import static purez.zawzaw.navbarscollection.ThemerConstants.THEME_READY_GOOGLE_APPS;
...
public class SubstratumLauncher extends Activity {
    ...
    private void getSubstratumFromPlayStore() {
        String playURL = "https://play.google.com/store/apps/details?id=projekt.purez";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SUBSTRATUM_FILTER_CHECK) Log.d("SubstratumLauncher", "This zawzaw is " +
                ((mVerified) ? "certified" : "uncertified") + " by purez!");
