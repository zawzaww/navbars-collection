package purez.zawzaw.navbarscollection
...
import purez.zawzaw.navbarscollection.Constants.ENABLE_KNOWN_THIRD_PARTY_THEME_MANAGERS
import purez.zawzaw.navbarscollection.Constants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION
import purez.zawzaw.navbarscollection.Constants.MINIMUM_SUBSTRATUM_VERSION
import purez.zawzaw.navbarscollection.Constants.OTHER_THEME_SYSTEMS
import purez.zawzaw.navbarscollection.Constants.SUBSTRATUM_FILTER_CHECK
import purez.zawzaw.navbarscollection.Constants.THEME_READY_GOOGLE_APPS
import purez.zawzaw.navbarscollection.Constants.THEME_READY_PACKAGES
import purez.zawzaw.navbarscollection.ThemeFunctions.SUBSTRATUM_PACKAGE_NAME
import purez.zawzaw.navbarscollection.ThemeFunctions.checkNetworkConnection
import purez.zawzaw.navbarscollection.ThemeFunctions.checkSubstratumIntegrity
import purez.zawzaw.navbarscollection.ThemeFunctions.getSelfSignature
import purez.zawzaw.navbarscollection.ThemeFunctions.getSelfVerifiedIntentResponse
import purez.zawzaw.navbarscollection.ThemeFunctions.getSelfVerifiedPirateTools
import purez.zawzaw.navbarscollection.ThemeFunctions.getSelfVerifiedThemeEngines
import purez.zawzaw.navbarscollection.ThemeFunctions.getSubstratumFromPlayStore
import purez.zawzaw.navbarscollection.ThemeFunctions.getSubstratumUpdatedResponse
import purez.zawzaw.navbarscollection.ThemeFunctions.hasOtherThemeSystem
import purez.zawzaw.navbarscollection.ThemeFunctions.isCallingPackageAllowed
import purez.zawzaw.navbarscollection.ThemeFunctions.isPackageInstalled
import java.io.File
import java.util.*
...
class SubstratumLauncher : Activity() {
    ...
    private var substratumIntentData = "projekt.purez.THEME"
    private var getKeysIntent = "projekt.purez.GET_KEYS"
    private var receiveKeysIntent = "projekt.purez.RECEIVE_KEYS"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!verified) {
            Log.e(tag, "This zawzaw does not support the launching zawzaw system. ($action)")
            Toast.makeText(this, R.string.unauthorized_theme_client, Toast.LENGTH_LONG).show()
            finish()
            return
        } else {
            Log.d(tag, "'$action' has been authorized to launch this zawzaw.")
        }
